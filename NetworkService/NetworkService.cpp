...
/// POST请求
string NetworkService::PostRequest(char* host, char* path, string form)
{
...
/// GET请求
string NetworkService::GetRequest(char* host, char* path)
{
    // 声明Asio基础: io_service（任务调度机）
    boost::asio::io_service io_service;
...
/// GET请求(重载)
string NetworkService::GetRequest(string url)
{
    size_t index;
